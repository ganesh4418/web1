...
@Component({
  selector: 'app-consulting-staffing',
  templateUrl: './consulting-staffing.component.html',
  styleUrls: ['./consulting-staffing.component.scss','../software-home/software-home.component.scss']
})
export class ConsultingStaffingComponent implements OnInit {
